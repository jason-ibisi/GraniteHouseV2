...
namespace GraniteHouseV2_DataAccess.Migrations
{
    ...
    [Migration("20220122185252_UpdatePrimaryKeyColumnOfOrderDetailTable")]
    partial class UpdatePrimaryKeyColumnOfOrderDetailTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.InquiryDetail", b =>
                {
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.InquiryHeader", b =>
                {
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.InquiryDetail", b =>
                {
                    b.HasOne("GraniteHouseV2_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GraniteHouseV2_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.InquiryHeader", b =>
                {
                    b.HasOne("GraniteHouseV2_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.OrderDetail", b =>
                {
                    b.HasOne("GraniteHouseV2_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("GraniteHouseV2_Models.OrderHeader", b =>
                {
                    b.HasOne("GraniteHouseV2_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
